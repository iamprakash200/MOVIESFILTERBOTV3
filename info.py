...
API_ID = int(environ['API_ID','16080598'])
API_HASH = environ['API_HASH','c4c3748047d877b7aab584ffa301fbb5']
BOT_TOKEN = environ['BOT_TOKEN','5059689925:AAGO-3HtsCF2_eDWHfgtxuDZwM_m9C2_Rkk']
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", JOIN [VK LINKZ](@VK_LINKZ) FOR MORE UPDATES)
